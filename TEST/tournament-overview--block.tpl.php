...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <h5 align="bottom">
                <i class="fa fa-trophy fa-2x" style="color:gold"></i> 1st Prize: <?php print $fields['field_tournament_prize']->content; ?>
            </h5>
        </div>
        <div class="col-sm-3">
            <h5 align="bottom">
                <i class="fa fa-trophy fa-2x" style="color:silver"></i> 2nd Prize: <?php print $fields['field_tournament_prize']->content; ?>
            </h5>
        </div>
        <div class="col-sm-3">
            <h5 align="bottom">
                <i class="fa fa-trophy fa-2x" style="color:gold"></i> 3rd Prize: <?php print $fields['field_tournament_prize']->content; ?>
            </h5>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-3">
            <strong>Max Team Size:</strong> <?php print $fields['field_maximum_team_size']->content; ?>
        </div>
        <div class="col-sm-3">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <strong>Max Teams:</strong> <?php print $fields['field_bracket_size']->content; ?><br>
